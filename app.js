...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('BeautyNow.xml', function(err, result) {
      ...
      result.BeautyNowMenu.section[obj.sec_n].entree.push({'item': obj.item, 'price': obj.price}); //If your XML elements are differet, this is where you have to change to your own element names
...
router.post('/post/delete', function(req, res) {
  ...
  function deleteJSON(obj) {
    ...
    xmlFileToJs('BeautyNow.xml', function(err, result) {
      ...
      delete result.BeautyNowMenu.section[obj.section].entree[obj.entree];
